...
// Camera feeds - Mix of YouTube live streams and RTSP camera
export const mockCameras: CameraData[] = [
  {
    id: 'cam-01',
    name: 'IP Camera RTSP (Local)',
    position: [-6, 2.5, 8],
    rotation: [0, Math.PI / 4, 0],
    // HLS stream from MediaMTX (after docker-compose up)
    streamUrl: 'http://localhost:8888/ipcamera1/index.m3u8',
    imageUrl: undefined,
    status: 'online',
    type: 'security',
    roomId: 'r24'
